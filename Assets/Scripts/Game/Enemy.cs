...
public class Enemy : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
         ...
         */
        var targetGO = GameManager.Instance.NearestPlayer(transform.position);
        if (targetGO != null)
        {
            var moveDirection = targetGO.transform.position - transform.position;
            mRigidBody.velocity = moveDirection.normalized * speed;
        }
    }
